...
def get_firebase_error(error_code):
    return firebase_errors.get(error_code, "Unknown error code: " + error_code)

if __name__ == "__main__":
    import sys
    if len(sys.argv) < 2:
        print("Usage: python firebaseErrorHandler.py <error_code>")
    else:
        print(get_firebase_error(sys.argv[1]))
